                  ...
                  <Carousel.Item key={index} className="candor-carousel">
                    ...
                    {dialogueMetaData &&
                      <Carousel.Caption className="d-block d-sm-none">
                        <div className="ml-3">
                          <span className="candor-bold"><ProfilePicture photoUrl={dialogueMetaData.poster.photoUrl} /> &nbsp; {dialogueMetaData.poster.displayName} / {dialogueMetaData.partner.displayName} &nbsp; <ProfilePicture photoUrl={dialogueMetaData.partner.photoUrl} /></span>
